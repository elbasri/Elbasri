<?php
namespace Elbasri\Zaincash\Controller;
/*
Zaincash Payment Controller
By: Junaid Bhura
www.junaidbhura.com
*/
...
class Payment{
//class Elbasri_Zaincash_PaymentController extends \Magento\Framework\App\Action\Action {
	...
	public function redirectAction() {
		...
		$redirection_url=Mage::getUrl('zaincash/payment/response');
